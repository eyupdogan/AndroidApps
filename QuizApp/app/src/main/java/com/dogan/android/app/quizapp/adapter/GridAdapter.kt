package com.dogan.android.app.quizapp.adapter
...
{
        private var onTouchResponse:IOnTouchResponse? = null
    ...
    fun setOnTouchResponse(onTouchResponse:IOnTouchResponse)
    {
        this.onTouchResponse = onTouchResponse
    }

    interface IOnTouchResponse
    {
        fun onClick(id:Int)
    }
}